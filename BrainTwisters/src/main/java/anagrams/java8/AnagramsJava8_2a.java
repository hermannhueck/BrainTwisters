...
/*
    Further improvement of AnagramsJava8_1b in Java 8
...
public class AnagramsJava8_2a {
    ...
    public static boolean isAnagram(String word, List<String> dictionary) {
        ...
        return sortedLowercaseWords(removeSameWord(word, dictionary)).contains(wordSorted);
    }

    private static List<String> removeSameWord(String word, List<String> dictionary) {
        return dictionary.stream().filter(entry -> !entry.equals(word)).collect(Collectors.toList());
    }
